...
if (jQuery("#apex-radialbar-chart").length) {
	options = {
		...
		colors: ["#9d713b", "#fe517e", "#6ce6f4", "#99f6ca"]
	};
...
if (jQuery("#apex-pie-chart").length) {
	options = {
		...
		colors: ["#9d713b", "#fe517e", "#6ce6f4", "#99f6ca", "#c8c8c8"],
		responsive: [{
			breakpoint: 480,
			options: {
				chart: {
...
if (jQuery("#am-simple-chart").length && am4core.ready(function() {
		...
		e.colors.list = [am4core.color("#9d713b")], e.data = [{
			country: "USA",
			visits: 2025
		}, {
			country: "China",
		...
		e.colors.list = [am4core.color("#9d713b")], e.exporting.menu = new am4core.ExportMenu;
		var t = e.xAxes.push(new am4charts.CategoryAxis);
		...
		n.name = "Expenses", n.dataFields.valueY = "expenses", n.dataFields.categoryX = "year", n.stroke = am4core.color("#9d713b"), n.strokeWidth = 3, n.propertyFields.strokeDasharray = "lineDash", n.tooltip.label.textAlign = "middle";
		...
		e.colors.list = [am4core.color("#9d713b"), am4core.color("#9d713b"), am4core.color("#99f6ca")], e.data = [{
			year: "2016",
			europe: 2.5,
			namerica: 2.5,
			asia: 2.1,
		...
		e.colors.list = [am4core.color("#9d713b"), am4core.color("#9d713b")], e.data = [{
			year: "2005",
			income: 23.5,
			expenses: 18.1
		}, {
		...
		e.colors.list = [am4core.color("#9d713b")], e.data = function() {
			var e = [],
				t = new Date;
		...
		a.category = "NW", a.endCategory = "NW", a.axisFill.fill = am4core.color("#9d713b"), a.axisFill.fillOpacity = .3;
		var n = t.axisRanges.create();
		n.category = "N", n.endCategory = "N", n.axisFill.fill = am4core.color("#9d713b"), n.axisFill.fillOpacity = .3;
		...
		t.colors.list = [am4core.color("#9d713b"), am4core.color("#fbc647"), am4core.color("#fe517e"), am4core.color("#6ce6f4"), am4core.color("#99f6ca"), am4core.color("#c8c8c8")], t.dataFields.value = "litres", t.dataFields.category = "country"
	}), jQuery("#am-layeredcolumn-chart").length && am4core.ready(function() {
		am4core.useTheme(am4themes_animated);
		var e = am4core.create("am-layeredcolumn-chart", am4charts.XYChart);
		e.colors.list = [am4core.color("#99f6ca"), am4core.color("#9d713b")], e.numberFormatter.numberFormat = "#.#'%'", e.data = [{
			country: "USA",
			year2004: 3.5,
			year2005: 4.2
		}, {
		...
		ykeys: ["y", "z", "a"],
		labels: ["Y", "Z", "A"],
		barColors: ["#9d713b", "#99f6ca", "#99f6ca"],
...
if (jQuery("#home-chart-03").length) {
	options = {
		...
		colors: ["#9d713b", "#6ce6f4", "#a09e9e", "#fbc647"],
		responsive: [{
			breakpoint: 480,
			options: {
				chart: {
...
jQuery("#home-chart-04").length && am4core.ready(function() {
	...
	e.colors.list = [am4core.color("#9d713b")];
	...
	e.colors.list = [am4core.color("#9d713b"), am4core.color("#9d713b")];
...
$(".table-add").on("click", "i", () => {
    ...
    if(jQuery('#sales-unit-chart').length){
	    ...
	    colors: ["#9d713b", "#fe517e", "#99f6ca", "#ffbf43"],
	    series: [{
	        name: 'Brands',
	        colorByPoint: true,
	        data: [{
    ...
    if(jQuery('#iq-chart-timeline').length){
		...
		chart.colors.list = [am4core.color("#9d713b")];
	...
	if(jQuery('#iq-chart-boxright2').length){
    	var options = {
          series: [{
            name: "Failed",
            data: [10, 10, 35]
        ...
        grid: {
          row: {
            colors: ['#ffbf43', 'transparent'], // takes an array which will be repeated on columns
            opacity: 0.5
          },
        },
        xaxis: {
        ...
        var chart = new ApexCharts(document.querySelector("#iq-chart-boxright2"), options);
        chart.render();
    }
    ...
    if(jQuery('#review-chart-demo').length){
        ...
        colors: ["#9d713b", "#65f9b3", "#ffbf43", "#fe517e","#9267ff"],
